...
import Awards from './AwardsComponent.js';
import Rating from './RatingComponent.js';
    ...
    return (
      <div>
        <section className="card-physical card card__title">
          ...
          <label className="card__label--bottom">{player.name} • {player.pos} • {player.college}

          </label>
          <Awards honors={player.awards} id={player.uuid}/>

        </section>
        <Rating ratings={player.ratings} />
      </div>
    )
  }
}
